class Form{
    ...
    displayrank(){
        ...
        message.html("Thank you "+player.name+" for playing the game");
        message.position(displayWidth/2-250,displayHeight/2-50);
        message.style('color', 'white');
        message.style('font-size', '50px');
        var rank=createElement('h3');
        rank.html("Your rank is "+player.rank)
        rank.position(displayWidth/2,displayHeight/2);
        rank.style('color', 'yellow');
        rank.style('font-size', '50px');
        rank.style('font-family', 'Baloo-Bahi');
    }
}
